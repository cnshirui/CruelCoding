...
export function Leaderboard({ members, contestDates }: { members: LeaderboardMember[]; contestDates: ContestDates }) {
  ...
  return <div className="board leaderboard-board">
